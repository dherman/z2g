...
FPp.print = function print() {
  // FIXME: escape xml
  console.log("  <apps:property name='from' value='" + this._addresses.join(" OR ") + "'/>");
};
...
TPp.print = function print() {
  // FIXME: escape xml
  console.log("  <apps:property name='to' value='" + this._addresses.join(" OR ") + "'/>");
};
...
SPp.print = function print() {
  // FIXME: escape xml
  console.log("  <apps:property name='subject' value='" + this._text + "'/>");
};

// function WordProperty() {
// }

// var WPp = WordProperty.prototype;

// WPp.print = function print() {
// };

// function NoWordProperty() {
// }

// var NWPp = NoWordProperty.prototype;

// NWPp.print = function print() {
// };
...
//exports.WordProperty = WordProperty;
//exports.NoWordProperty = NoWordProperty;
